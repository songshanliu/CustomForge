...
const defaultLabels: WorkbenchLabels = {
  ...
  showDesignGuide: 'Show product guide',
  hideDesignGuide: 'Hide product guide',
  designArea: 'Design area',
  previousArea: 'Previous design area',
  nextArea: 'Next design area',
  zoomIn: 'Zoom in',
  zoomOut: 'Zoom out',
  fitDesignArea: 'Fit design area',
  actualSize: '100% view',
  selectSurface: 'Select surface',
  cancelSurfacePick: 'Cancel surface selection',
  textObject: 'Text',
  imageObject: 'Image',
  backgroundObject: 'Background',
  designGuideTemplateUrl: 'Design guide template URL',
  showUvGuide: 'Show UV island boundaries',
  ...
  productDialogTitle: 'Load remote product',
  modelUrl: 'GLB or GLTF URL',
  modelFile: 'Local GLB file',
  automaticMode: 'Automatic areas',
  existingUvMode: 'Existing mesh UV',
  textureUrl: 'Base texture URL',
  surfaceMesh: 'Customizable mesh',
  flipTexture: 'Flip texture vertically',
  useDemo: 'Use built-in demo',
  starting: 'Starting',
  productReady: 'Product ready',
  loadingModel: 'Loading model',
  inspectingGeometry: 'Inspecting geometry',
  findingDesignAreas: 'Finding design areas',
  unwrappingSurface: 'Unwrapping surface',
